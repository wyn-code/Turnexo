from sqlalchemy import Column, Integer, DateTime, ForeignKey, Text, SmallInteger, BigInteger
...
class Turno(Base):
    ...
    id_negocio = Column(BigInteger, ForeignKey("negocios.id_ng"), nullable=False)
